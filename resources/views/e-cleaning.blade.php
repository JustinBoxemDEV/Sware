    ...
    <div class="col-md-6">
        <div class="services-block">
            ...
            <div class="page-header">
                <h1 class="e-cleaning-page-header">&LT;/ E-Cleaning&GT;</h1>
            </div>
            <div class="e-cleaning-text">
                <h2>
                    PC traag? Programma wil maar niet starten en/of loopt steeds vast? Het kan best maar eens zo zijn dat uw systeem geinfecteerd
                    is met Malware en/of Virussen. Maar geen zorgen: &LT;S/ Ware&GT; heeft de oplossing!
                    <br>
                    <br>
                    <h2 class="e-cleaning-subheader">Hoe wij uw PC opknappen:</h2>
                    <br>
                    <br>
                    <ul>
